async function ArasanModule(moduleArg = {}) {
  ...
  function findWasmBinary() {
    if (Module["locateFile"]) {
      return locateFile("arasan-browser.wasm");
    }
    return new URL("arasan-browser.wasm", import.meta.url).href;
  }
  ...
  function assignWasmExports(wasmExports) {
    _main = Module["_main"] = wasmExports["F"];
    _emscripten_builtin_memalign = wasmExports["H"];
